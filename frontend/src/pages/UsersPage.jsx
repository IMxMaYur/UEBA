...
export default function UsersPage() {
  ...
  const [sortBy, setSortBy]   = useState('risk')      // 'risk' | 'id' | 'dept'
  ...
  const filtered = users
    ...
    .sort((a, b) => {
      ...
      return b.risk_score - a.risk_score   // default: risk desc
    })
            ...
            <tbody>
              {filtered.map(user => (
                ...
                >
                  ...
                  <td>
                    {user.open_alerts > 0
                      ? <span style={{ fontSize: 13, fontWeight: 700, color: '#ef4444' }}>{user.open_alerts}</span>
